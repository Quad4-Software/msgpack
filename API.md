...
Reference for `github.com/Quad4-Software/msgpack/v5/pkg/msgpack`. Designed to be useful both as human documentation and as a single grounding document for LLM coding agents that need to write or review code against this library.
...
```go
import "github.com/Quad4-Software/msgpack/v5/pkg/msgpack/msgpcode"
```
...
- Always import the package as `msgpack`; the import path is `github.com/Quad4-Software/msgpack/v5/pkg/msgpack`. Do not generate `github.com/vmihailenco/...` paths in this codebase.
- Wire codes live in `github.com/Quad4-Software/msgpack/v5/pkg/msgpack/msgpcode`.
